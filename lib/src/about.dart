...
class _MasterDetailFlow extends StatefulWidget {
  ...
  /// builds the master view inside a [Scaffold] with an [FluentAppBar].
  ...
  /// The title for the lateral UI [FluentAppBar].
  ///
  /// See [FluentAppBar.title].
  final Widget? title;

  /// A widget to display before the title for the lateral UI [FluentAppBar].
  ///
  /// See [FluentAppBar.leading].
  final Widget? leading;

  /// Override the framework from determining whether to show a leading widget or not.
  ///
  /// See [FluentAppBar.automaticallyImplyLeading].
  final bool automaticallyImplyLeading;

  /// Override the framework from determining whether to display the title in the center of the
  /// app bar or not.
  ///
  /// See [FluentAppBar.centerTitle].
  final bool? centerTitle;

  /// See [FluentAppBar.flexibleSpace].
  ...
  /// are for the master
  /// view toolbar. Finally, if the [FluentAppBar] for the master page for the nested UI is being built
