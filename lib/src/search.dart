...
/// screen triggering the transition contains an [FluentAppBar] at the top and the
/// transition is called from an [IconButton] that's part of [FluentAppBar.actions].
...
/// the [FluentAppBar.leading] position e.g. from the hamburger menu to the back arrow
...
///
/// The search page always shows an [FluentAppBar] at the top where users can
...
/// across the bottom of the [FluentAppBar] via [SearchDelegate.buildBottom].
///
/// The body below the [FluentAppBar] can either show suggested queries (returned by
...
abstract class SearchDelegate<T> {
  ...
  /// A widget to display before the current query in the [FluentAppBar].
  ///
  ...
  /// See also:
  ///
  ///  * [FluentAppBar.leading], the intended use for the return value of this method.
  Widget buildLeading(BuildContext context);

  /// Widgets to display after the search query in the [FluentAppBar].
  ///
  ...
  /// See also:
  ///
  ///  * [FluentAppBar.actions], the intended use for the return value of this method.
  List<Widget> buildActions(BuildContext context);

  /// Widget to display across the bottom of the [FluentAppBar].
  ///
  /// Returns null by default, i.e. a bottom widget is not included.
  ///
  /// See also:
  ///
  ///  * [FluentAppBar.bottom], the intended use for the return value of this method.
  ///
  ...
  /// The current query string shown in the [FluentAppBar].
  ///
...
/// Describes the body that is currently shown under the [FluentAppBar] in the
/// search page.
enum _SearchBody {
